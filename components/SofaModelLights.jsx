...
const SofaModelLights = ({switchLight,setswitchLight}) => {
  return (
    <>
    <div onClick={()=>setswitchLight({...switchLight,first:!switchLight.first})} className={`absolute top-14 left-[60px] h-[50px] rotate-[-45deg] cursor-pointer ${switchLight.first?'':'grayscale'}`}>
