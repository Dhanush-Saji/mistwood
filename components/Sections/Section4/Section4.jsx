 ...
 <div className='relative'>
        ...
        <div className='categories relative grid grid-cols-1 md:grid-cols-3 gap-3 mt-10 md:mt-16 bg-white dark:bg-transparent'>
          ...
          <Link className='category1 overflow-hidden rounded-lg md:rounded-none md:rounded-tl-[4rem] max-h-[50vh] cursor-pointer relative' href={'/shop?category=Chair'} prefetch={false}>
            <Image width={200} height={200} src={category[0]?.category_image?.url} alt="category" className='transition-all object-cover w-full h-full duration-500' />
            <div className="overlay">
          ...
          <Link className='overflow-hidden rounded-lg md:rounded-none category2 cursor-pointer relative'prefetch={false} href={'/shop?category=Bed'}>
            <Image width={200} height={200} src={category[1]?.category_image?.url} alt="category" className='transition-all object-cover w-full h-full duration-500' />
            <div className="overlay">
            ...
            <Image width={200} height={200} src={category[2]?.category_image?.url} alt="category" className='transition-all object-cover w-full h-full duration-500' />
            <div className="overlay">
          ...
          <Image width={200} height={200} src={category[3]?.category_image?.url} alt="category" className='transition-all object-cover w-full h-full duration-500' />
          <div className="overlay">
