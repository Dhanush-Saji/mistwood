      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="px-5 py-2 rounded-md bg-white" value={formData?.name} onChange={(e)=>setformData({...formData, name: e.target.value})}
            />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="px-5 py-2 rounded-md bg-white" value={formData?.email} onChange={(e)=>setformData({...formData, email: e.target.value})}
            />
          </div>
        </div>
        <div className="flex flex-col gap-2 mt-5">
          ...
          <textarea
            ...
            cols="8"
            rows="8"
            className="px-5 py-2 rounded-md bg-white" value={formData?.message} onChange={(e)=>setformData({...formData, message: e.target.value})}
          ></textarea>
        </div>
